...
* [Uptime-Kuma](https://github.com/louislam/uptime-kuma) ⭐ 90,161 | 🐛 784 | 🌐 JavaScript | 📅 2026-08-14 - A self-hosted monitoring tool like "Uptime Robot".
* [Upptime](https://github.com/upptime/upptime) ⭐ 17,134 | 🐛 68 | 🌐 Markdown | 📅 2026-08-14 - monitor and status page powered by GitHub
* [Cachet](https://cachethq.io/) - Laravel based status page system for everyone. [3.x coming soon](https://github.com/cachethq/cachet/discussions/4342) ⭐ 15,214 | 🐛 6 | 🌐 PHP | 📅 2026-08-11.
* [Gatus](https://github.com/TwinProduction/gatus) ⭐ 11,806 | 🐛 360 | 🌐 Go | 📅 2026-08-09 - Automated service health dashboard
* [Checkmate](https://github.com/bluewave-labs/Checkmate) ⭐ 10,520 | 🐛 117 | 🌐 TypeScript | 📅 2026-08-12 (previously "BlueWave Uptime") - Checkmate is an open-source, self-hosted monitoring tool built with React.js, Node.js, and MongoDB, designed to track server uptime, response times, and incidents in real-time, featuring a modern UI. Additionally, Checkmate supports E-mail, Webhook, Discord and Slack notifications and has a multi-language frontend.
* [HertzBeat](https://github.com/dromara/hertzbeat) ⭐ 7,360 | 🐛 333 | 🌐 Java | 📅 2026-08-14 - An open source, real-time monitoring system with agentless, cluster, prometheus-compatible, custom and status page.
* ~~[Corestats](https://github.com/jayfk/statuspage) ⭐ 3,874 | 🐛 37 | 🌐 Python | 📅 2022-11-15~~ - *(Discontinued / Un-Supported)*
* [UptimeFlare](https://github.com/lyc8503/UptimeFlare) ⭐ 3,723 | 🐛 21 | 🌐 TypeScript | 📅 2026-06-01 - Another monitoring & status page completely powered by Cloudflare Workers & Pages.
...
* [statping-ng](https://github.com/statping-ng/statping-ng) ⭐ 1,986 | 🐛 194 | 🌐 Go | 📅 2025-06-04 - Actively maintained fork of [statping/statping](https://github.com/statping/statping) ⭐ 7,291 | 🐛 48 | 🌐 Vue | 📅 2024-07-05
* [ciao](https://github.com/brotandgames/ciao) ⭐ 1,972 | 🐛 2 | 🌐 Ruby | 📅 2026-07-16 - checks HTTP(S) URL endpoints for a HTTP status code (or errors on the lower TCP stack) and sends a notification on status change via E-Mail or Webhooks.
...
* [Peekaping](https://github.com/0xfurai/peekaping) ⭐ 1,173 | 🐛 91 | 🌐 Go | 📅 2026-05-24 - A self-hosted uptime monitoring with real-time dashboard, multi-channel notifications, status pages, and analytics.
...
* [Static status](https://github.com/Cyclenerd/static_status) ⭐ 733 | 🐛 5 | 🌐 Shell | 📅 2026-08-11 - Bash script to generate a static status page
...
* [Fettle](https://github.com/mehatab/fettle) ⭐ 279 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-14 - An open-source, GitHub-powered status page project utilizing GitHub Pages, Actions, and Issues for real-time updates and incident management.
...
- [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 127 | 🐛 21 | 🌐 TypeScript | 📅 2026-08-14 — Multi-cluster Kubernetes management console with built-in cluster health dashboards; provides real-time status monitoring across cloud and edge Kubernetes deployments.

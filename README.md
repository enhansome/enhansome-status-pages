...
* [Uptime-Kuma](https://github.com/louislam/uptime-kuma) ⭐ 90,556 | 🐛 786 | 🌐 JavaScript | 📅 2026-08-24 - A self-hosted monitoring tool like "Uptime Robot".
...
* [HertzBeat](https://github.com/dromara/hertzbeat) ⭐ 7,374 | 🐛 310 | 🌐 Java | 📅 2026-08-24 - An open source, real-time monitoring system with agentless, cluster, prometheus-compatible, custom and status page.
...
* [AIWatch](https://github.com/bentleypark/aiwatch) ⭐ 27 | 🐛 72 | 🌐 TypeScript | 📅 2026-08-24 - Open-source dashboard for monitoring third-party AI services (31 services including Claude, OpenAI, Gemini, Mistral, Groq) with reliability scoring, incident analysis, and Discord/Slack alerts. Built on Cloudflare Workers + KV. Live demo at <https://ai-watch.dev>. AGPL-3.0.

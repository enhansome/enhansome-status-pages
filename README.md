...
* [Uptime-Kuma](https://github.com/louislam/uptime-kuma) ⭐ 91,163 | 🐛 800 | 🌐 JavaScript | 📅 2026-09-09 - A self-hosted monitoring tool like "Uptime Robot".
* [Upptime](https://github.com/upptime/upptime) ⭐ 17,152 | 🐛 65 | 🌐 Markdown | 📅 2026-09-09 - monitor and status page powered by GitHub
...
* [Gatus](https://github.com/TwinProduction/gatus) ⭐ 12,031 | 🐛 381 | 🌐 Go | 📅 2026-09-08 - Automated service health dashboard
* [Checkmate](https://github.com/bluewave-labs/Checkmate) ⭐ 10,803 | 🐛 114 | 🌐 TypeScript | 📅 2026-09-08 (previously "BlueWave Uptime") - Checkmate is an open-source, self-hosted monitoring tool built with React.js, Node.js, and MongoDB, designed to track server uptime, response times, and incidents in real-time, featuring a modern UI. Additionally, Checkmate supports E-mail, Webhook, Discord and Slack notifications and has a multi-language frontend.
* [HertzBeat](https://github.com/dromara/hertzbeat) ⭐ 7,388 | 🐛 312 | 🌐 Java | 📅 2026-09-09 - An open source, real-time monitoring system with agentless, cluster, prometheus-compatible, custom and status page.
* ~~[Corestats](https://github.com/jayfk/statuspage) ⭐ 3,870 | 🐛 37 | 🌐 Python | 📅 2022-11-15~~ - *(Discontinued / Un-Supported)*
* [UptimeFlare](https://github.com/lyc8503/UptimeFlare) ⭐ 3,790 | 🐛 21 | 🌐 TypeScript | 📅 2026-06-01 - Another monitoring & status page completely powered by Cloudflare Workers & Pages.
...
* [statping-ng](https://github.com/statping-ng/statping-ng) ⭐ 1,988 | 🐛 193 | 🌐 Go | 📅 2025-06-04 - Actively maintained fork of [statping/statping](https://github.com/statping/statping) ⭐ 7,289 | 🐛 48 | 🌐 Vue | 📅 2024-07-05
...
* [Peekaping](https://github.com/0xfurai/peekaping) ⭐ 1,189 | 🐛 92 | 🌐 Go | 📅 2026-05-24 - A self-hosted uptime monitoring with real-time dashboard, multi-channel notifications, status pages, and analytics.
...
* [Fettle](https://github.com/mehatab/fettle) ⭐ 281 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-09 - An open-source, GitHub-powered status page project utilizing GitHub Pages, Actions, and Issues for real-time updates and incident management.
...
* [AIWatch](https://github.com/bentleypark/aiwatch) ⭐ 27 | 🐛 76 | 🌐 TypeScript | 📅 2026-09-09 - Open-source dashboard for monitoring third-party AI services (31 services including Claude, OpenAI, Gemini, Mistral, Groq) with reliability scoring, incident analysis, and Discord/Slack alerts. Built on Cloudflare Workers + KV. Live demo at <https://ai-watch.dev>. AGPL-3.0.
...
- [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 133 | 🐛 169 | 🌐 TypeScript | 📅 2026-09-09 — Multi-cluster Kubernetes management console with built-in cluster health dashboards; provides real-time status monitoring across cloud and edge Kubernetes deployments.

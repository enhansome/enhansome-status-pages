...
* [Uptime-Kuma](https://github.com/louislam/uptime-kuma) ⭐ 90,721 | 🐛 792 | 🌐 JavaScript | 📅 2026-08-29 - A self-hosted monitoring tool like "Uptime Robot".
* [Upptime](https://github.com/upptime/upptime) ⭐ 17,148 | 🐛 65 | 🌐 Markdown | 📅 2026-08-29 - monitor and status page powered by GitHub
...
* [Vigil](https://github.com/valeriansaliou/vigil) ⭐ 1,942 | 🐛 42 | 🌐 Rust | 📅 2026-05-03 - Microservices Status Page. Monitors a distributed infrastructure and sends alerts (Slack, SMS, etc.).
...
* [Fettle](https://github.com/mehatab/fettle) ⭐ 280 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-28 - An open-source, GitHub-powered status page project utilizing GitHub Pages, Actions, and Issues for real-time updates and incident management.
...
- [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 129 | 🐛 15 | 🌐 TypeScript | 📅 2026-08-29 — Multi-cluster Kubernetes management console with built-in cluster health dashboards; provides real-time status monitoring across cloud and edge Kubernetes deployments.
